...
namespace env
{
    ...
    void Manager::removeEnvVariable(char const *key)
    {
        std::size_t success{_internalEnv.erase(key)};
    ...
    std::string &Manager::getEnvVariable(std::string const &key)
    {
        try {
            return _internalEnv.at(key);
        } catch (std::out_of_range &e) {
    ...
    std::string &Manager::getEnvVariable(char const *key)
    {
        try {
            return _internalEnv.at(key);
        } catch (std::out_of_range &e) {
    ...
    std::string &Manager::operator[](std::string const &str)
    {
        return this->getEnvVariable(str);
    }

    std::string &Manager::operator[](char const *str)
    {
        return this->getEnvVariable(str);
    }
    ...
    const std::string &Manager::operator[](char const *str) const
    {
        return this->getEnvVariable(str);
    }
